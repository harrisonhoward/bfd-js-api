    ...
    static async Embed(bot) {
        try {
            ...
            return new Canvas(500, 280)
                ...
                .setTextAlign("right")
                .addText(botName.length > 16 ? botName.substring(botName.length - 16, botName.length) : botName, 442, 108)
                .addText(ownerName.length > 15 ? ownerName.substring(ownerName.length - 15, ownerName.length) : ownerName, 442, 158)
                .addText(botCount.length > 15 ? botCount.substring(botCount.length - 15, botCount.length) : botCount, 442, 208)
