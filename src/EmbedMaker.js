    ...
    static async Embed(bot) {
        try {
            ...
            return new Canvas(500, 280)
                ...
                .setTextAlign("right")
                .addText(botName.length > 14 ? "..." + botName.substring(botName.length - 14) : botName, 442, 108)
                .addText(ownerName.length > 13 ? "..." + ownerName.substring(ownerName.length - 13) : ownerName, 442, 158)
                .addText(botCount.length > 13 ? "..." + botCount.substring(botCount.length - 13) : botCount, 442, 208)
