    ...
    static async Embed(bot) {
        try {
            ...
            return new Canvas(500, 280)
                ...
                .setTextAlign("right")
                .addText(botName.length > 15 ? "..." + botName.substring(botName.length - 15) : botName, 442, 108)
                .addText(ownerName.length > 14 ? "..." + ownerName.substring(ownerName.length - 14) : ownerName, 442, 158)
                .addText(botCount.length > 14 ? "..." + botCount.substring(botCount.length - 14) : botCount, 442, 208)
