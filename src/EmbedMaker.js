    ...
    static async Embed(bot) {
        try {
            ...
            return new Canvas(500, 280)
                ...
                .setTextAlign("right")
                .addText(botName.length > 16 ? botName.substring(botName.length - 16) : botName, 442, 108)
                .addText(ownerName.length > 15 ? ownerName.substring(ownerName.length - 15) : ownerName, 442, 158)
                .addText(botCount.length > 15 ? botCount.substring(botCount.length - 15) : botCount, 442, 208)
